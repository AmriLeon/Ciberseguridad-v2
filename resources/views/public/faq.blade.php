...
<div class="bg-gray-800/80 bg-opacity-50 relative z-10 py-16">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-5xl font-extrabold text-[#37A67C] text-center mb-16 animate-fade-in-up">Preguntas Frecuentes</h1>
    
    <!-- Registration & Tickets Section -->
    <div class="mb-8">
        <h2 class="text-2xl font-semibold text-[#37A67C] mb-4"><i class="fas fa-ticket-alt mr-3"></i>Registro y Boletos</h2>
        <div class="space-y-4">
            <div class="border border-gray-700 rounded-lg hover:border-[#73E0B7] transition-colors duration-300 shadow-lg hover:shadow-blue-500/20 bg-gray-800 bg-opacity-60 backdrop-blur-sm hover:bg-opacity-70">
                <button class="w-full px-6 py-4 text-left text-white hover:bg-gray-800/50 transition-all duration-300 flex justify-between items-center group">
                    ...
                    <i class="fas fa-chevron-down text-[#37A67C] group-hover:text-blue-400 transition-transform duration-300"></i>
                </button>
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-semibold text-[#45B088] mb-4"><i class="fas fa-calendar-alt mr-3"></i>Información del Evento</h2>
        <div class="space-y-4">
            <div class="border border-gray-700 rounded-lg hover:border-[#73E0B7] transition-colors duration-300 shadow-lg hover:shadow-blue-500/20 bg-gray-800 bg-opacity-60 backdrop-blur-sm hover:bg-opacity-70">
                <button class="w-full px-6 py-4 text-left text-white hover:bg-gray-800/50 transition-all duration-300 flex justify-between items-center group">
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-semibold text-[#5AB693] mb-4"><i class="fas fa-laptop-code mr-3"></i>Requisitos Técnicos</h2>
        <div class="space-y-4">
            <div class="border border-gray-700 rounded-lg hover:border-[#73E0B7] transition-colors duration-300 shadow-lg hover:shadow-blue-500/20 bg-gray-800 bg-opacity-60 backdrop-blur-sm hover:bg-opacity-70">
                <button class="w-full px-6 py-4 text-left text-white hover:bg-gray-800/50 transition-all duration-300 flex justify-between items-center group">
